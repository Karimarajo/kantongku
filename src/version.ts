...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    changes: [
      'Perbaikan halaman promosi (landing page) — bukan aplikasi utama, tidak ada perubahan untuk pengguna yang sudah berlangganan: rapikan kartu perbandingan harga yang sempat kepotong, testimoni jadi gaya pesan chat, dan kartu fitur/tampilan hero sekarang menampilkan cuplikan UI aplikasi yang digambar ulang (bukan tempelan gambar), ikut berubah gelap/terang sesuai toggle.',
    ],
  },
  {
    version: '7.8',
    date: '7 September 2026',
    changes: [
      'Penyesuaian warna halaman promosi (landing page) — bukan aplikasi utama, tidak ada perubahan untuk pengguna yang sudah berlangganan: ganti kombinasi warna jadi hijau mint, navy gelap, hijau tua, dan putih sesuai preferensi terbaru.',
    ],
  },
  {
    version: '7.7',
    date: '7 September 2026',
    changes: [
      'Revisi lanjutan halaman promosi (landing page) — bukan aplikasi utama, tidak ada perubahan untuk pengguna yang sudah berlangganan: latar benar-benar putih dengan toggle mode terang/gelap sendiri, header dengan nama "KantongKu", section kepercayaan (Trust Bar) dan cerita di balik KantongKu (Marajo Tech), testimoni asli, dan form pemesanan kini juga meminta Nomor WhatsApp.',
    ],
  },
  {
    version: '7.6',
    date: '7 September 2026',
    changes: [
      'Revisi halaman promosi (landing page) — bukan aplikasi utama, tidak ada perubahan untuk pengguna yang sudah berlangganan: tampilan latar terang, FAQ diperluas jadi 15 pertanyaan, dan judul halaman kini menyesuaikan iklan mana yang membawa pengunjung ke sana.',
    ],
  },
  {
    version: '7.5',
