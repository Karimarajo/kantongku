...
export default function UpdateForever() {
  return (
    <section className="w-full px-6 py-12">
      <div className="max-w-2xl mx-auto flex flex-col items-center gap-4 text-center bg-surface-variant/20 border border-overlay/10 rounded-2xl p-8">
        <div className="w-12 h-12 rounded-full bg-primary/10 border border-primary/20 flex items-center justify-center">
          <InfinityIcon className="w-6 h-6 text-primary" />
        </div>
        <h3 className="text-lg sm:text-xl font-bold text-on-surface">Sekali Beli, Update Selamanya</h3>
        ...
        <div className="flex items-center gap-2 text-xs text-on-surface-variant/70 bg-overlay/5 border border-overlay/10 rounded-full px-4 py-2">
